...
5.  **Quan trọng:** Truy cập tab **Actions** trong repository GitHub của bạn, chọn `Update DNS Blocklists`, và nhấn **Enable workflow**. Sau đó, nhấn **Run workflow** để tải các bộ lọc lần đầu tiên.
